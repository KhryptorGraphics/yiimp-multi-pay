...
<li>Use the <a href="/site/mining_groups">Mining Groups</a> page to see which operator-curated bundles are ready to mine together, which pools are dedicated, and which payout addresses are still missing from your session.</li>
...
<li>For grouped mining bundles, open <a href="/site/mining_groups">/site/mining_groups</a> and copy the bundle-specific host, username, and password flags from the curated public group list.</li>
